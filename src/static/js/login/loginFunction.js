...
function setLocalStorageAccount(res, username) {
  ...
  user({
    ...
    .then((res) => {
      if (res.data.code === 200) {
        setLocalStorageAccount(res, account.username);
        router.push("project");
      } else {
        ElMessage({
          showClose: true,
...
function register_btn(router) {
  ...
  reg({
    ...
    .then((res) => {
      if (res.data.code === 200) {
        setLocalStorageAccount(res, register.username);
        router.push("project");
      } else {
        ElMessage({
          showClose: true,
...
export { getLocalStorageAccount, querySearch, login_btn, register_btn };

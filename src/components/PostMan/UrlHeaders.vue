<template>
  <div class="title"><p>Headers</p></div>
  ...
  <form v-for="item in rq_info.headers" :key="item">
    <div class="params">
      <div>
      ...
      <el-button type="primary" link @click="Delete_HeadersParam(item)"
        >删除</el-button
      >
    </div>
  </form>
  ...
  <div class="add-parmas">
    <el-button type="primary" plain @click="Add_HeadersParam"
      >添加参数</el-button
    >
  </div>
</template>
